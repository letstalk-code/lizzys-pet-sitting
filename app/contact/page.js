      ...
      <section className="hero-clip relative pt-52 pb-44 bg-orange text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-white/80 text-xl font-light max-w-xl mx-auto leading-relaxed">
            Whether you have questions or you&apos;re ready to schedule, Elisabeth is here. Reach out and let&apos;s build the perfect care plan for your pet.
          </p>
        </div>
      </section>
            ...
            <div className="bg-teal text-white p-12 lg:p-16 lg:w-5/12 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/75 text-lg font-light leading-relaxed mb-12">
                  Every pet is unique. Fill out the form and Elisabeth will get back to you personally to discuss the best care plan.
                </p>
                <div className="space-y-8">
                  {[
                    { icon:'ph-map-pin', title:'Service Area', val:'Florida, USA' },
                    { icon:'ph-phone', title:'Office', val:'(727) 653-0427', href:'tel:+17276530427' },
                    { icon:'ph-printer', title:'Fax', val:'(727) 626-2256' },
            ...
            <div className="p-10 md:p-14 lg:w-7/12 bg-white">
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-20 text-center">
                  ...
                  <p className="text-charcoal/55 font-light">Elisabeth will be in touch shortly. Your pet is in great hands.</p>
                </div>
              ) : (
                <>
                  <h3 className="font-heading font-bold text-2xl text-charcoal mb-2">Send a Message</h3>
                  <p className="text-charcoal/50 font-light text-sm mb-8">Tell Elisabeth about your pet and what you need — she&apos;ll respond personally.</p>
                  <form onSubmit={async e => {
                    ...
                    <div className="field-wrap">
                      ...
                      <label htmlFor="message">Tell Elisabeth about your pet...</label>
                    </div>
      ...
      <section className="py-24 bg-cream relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 reveal">
            ...
            <p className="text-charcoal/55 font-light mt-4 max-w-xl mx-auto">Elisabeth serves Clearwater and the surrounding Pinellas County communities. Not sure if you&apos;re in range? Just reach out!</p>
          </div>
